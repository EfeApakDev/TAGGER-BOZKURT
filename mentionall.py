...
api_id = int(os.environ.get("8531218"))
api_hash = os.environ.get("b46a5648fb6c47438d037c052d1fa8ba")
bot_token = os.environ.get("5236314945:AAH-i-A_-SSx8zUUGsaWo_ogeGFlhUkLqR8")
...
async def start(event):
  await event.reply("** BOZKURT Tagger🇹🇷**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim @bozkurt20 ★\nDaha fazla bilgi için **/bilgi**'i tıklayın.",
                    buttons=(
                      [
                      ...
                      [
                         ...
                         Button.url('🎆 Sahibi', 'https://t.me/bozkurt20')
                      ]
                    ),
                    link_preview=False
                   )
  ...
  if mode == "text_on_cmd":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in tekli_calisan:
        await event.respond("**Işlem Başarıyla Durduruldu\n\n**Buda sizin reklamınız ola bilir @Bozkurtaggerbot**❌****")
        return
      if usrnum == 1:
...
print(">> Bot çalışıyor 🚀 @bozkurt20  bilgi alabilirsin <<")
